...
jk.errors <- matrix(NA, 2895, 10) # Length 3047, 28 vars total
...
cvmodel <- train(target_deathrate ~ ., data = na.omit(cancer2), method = "lm", trControl = train.control)
print(cvmodel)
...
```{r}
model_eq <- model.matrix(target_deathrate ~ ., data = na.omit(cancer2))[, -1]
